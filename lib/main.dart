  ...
  Widget build(BuildContext context) {
    ...
    return MaterialApp(
      ...
      theme: ThemeData(
        ...
        colorScheme: ColorScheme.fromSeed(seedColor: const Color.fromARGB(255, 171, 9, 9)), // Gera um esquema de cores baseado na cor deepPurple.
        useMaterial3: true, // Ativa o estilo Material Design 3.
      ),
      home: const MyHomePage(title: 'Programa 1 Flutter'), // Define a página inicial do aplicativo.
    );
  }
}
        ...
        child: Column(
          ...
          children: <Widget>[
            const Text(
              ...
              'Primeira Criação Flutter, clique (+) na tela para ganhar pontos:',
            ),
            Text(
